...
const TabArr = [
  ...
  { route: 'DrawerNavigator', label: 'Add', type: Icons.Feather, icon: 'plus-square', component: DrawerNavigator },
  { route: 'WalletScreen', label: 'Like', type: Icons.Feather, icon: 'heart', component: WalletScreen },
];
